...
# If true, each write commit waits for synchronous S3 upload before returning.
STORE_ROCKSDB_CLOUD_S3_FIRST_MODE="${STORE_ROCKSDB_CLOUD_S3_FIRST_MODE:-true}"
...
services:
  ...
  store0:
    ...
    environment:
      ...
      HG_STORE_ROCKSDB_CLOUD_S3_BUCKET: "${S3_BUCKET_STORE0}"
      HG_STORE_ROCKSDB_CLOUD_S3_ENDPOINT: "${S3_ENDPOINT}"
      HG_STORE_ROCKSDB_CLOUD_S3_REGION: "${S3_REGION}"
      HG_STORE_ROCKSDB_CLOUD_S3_ACCESS_KEY: "${MINIO_ROOT_USER}"
      HG_STORE_ROCKSDB_CLOUD_S3_SECRET_KEY: "${MINIO_ROOT_PASSWORD}"
      HG_STORE_ROCKSDB_CLOUD_S3_PATH_STYLE: "true"
      HG_STORE_ROCKSDB_CLOUD_S3_OBJECT_PREFIX: ""
      ...
      HG_STORE_ROCKSDB_CLOUD_S3_FIRST_MODE: "${STORE_ROCKSDB_CLOUD_S3_FIRST_MODE}"
    ports:
      - "8520:8520"
    volumes:
  ...
  store1:
    ...
    environment:
      ...
      HG_STORE_DATA_PATH: /hugegraph-store/storage
      HG_STORE_ROCKSDB_CLOUD_ENABLED: "${STORE_ROCKSDB_CLOUD_ENABLED}"
      HG_STORE_ROCKSDB_CLOUD_S3_BUCKET: "${S3_BUCKET_STORE1}"
      HG_STORE_ROCKSDB_CLOUD_S3_ENDPOINT: "${S3_ENDPOINT}"
      HG_STORE_ROCKSDB_CLOUD_S3_REGION: "${S3_REGION}"
      HG_STORE_ROCKSDB_CLOUD_S3_ACCESS_KEY: "${MINIO_ROOT_USER}"
      HG_STORE_ROCKSDB_CLOUD_S3_SECRET_KEY: "${MINIO_ROOT_PASSWORD}"
  ...
  store2:
    ...
    environment:
      ...
      HG_STORE_DATA_PATH: /hugegraph-store/storage
      HG_STORE_ROCKSDB_CLOUD_ENABLED: "${STORE_ROCKSDB_CLOUD_ENABLED}"
      HG_STORE_ROCKSDB_CLOUD_S3_BUCKET: "${S3_BUCKET_STORE2}"
      HG_STORE_ROCKSDB_CLOUD_S3_ENDPOINT: "${S3_ENDPOINT}"
      HG_STORE_ROCKSDB_CLOUD_S3_REGION: "${S3_REGION}"
      HG_STORE_ROCKSDB_CLOUD_S3_ACCESS_KEY: "${MINIO_ROOT_USER}"
      HG_STORE_ROCKSDB_CLOUD_S3_SECRET_KEY: "${MINIO_ROOT_PASSWORD}"

...
| Store Snapshot | `SnapshotHandlerTest`；归档 `docs/evidence/rust-rewrite/store-core-profile-20260913.log`（SHA-256 `084a53c5204c89ba65657414cf1de9714c2b7f55c5733a17465c12037c0b6f95`） | 5/5 通过 | 真实文件 round-trip、损坏快照、重启恢复 |
